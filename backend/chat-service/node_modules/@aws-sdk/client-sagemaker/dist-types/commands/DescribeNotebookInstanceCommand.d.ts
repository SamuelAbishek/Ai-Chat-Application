...
declare const DescribeNotebookInstanceCommand_base: {
    new (input: DescribeNotebookInstanceCommandInput): import("@smithy/core/client").CommandImpl<DescribeNotebookInstanceCommandInput, DescribeNotebookInstanceCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeNotebookInstanceCommandInput): import("@smithy/core/client").CommandImpl<DescribeNotebookInstanceCommandInput, DescribeNotebookInstanceCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
